...
#define BALANCE_ANGLE -2.5f //-1.5, -1.3
...
PIDClass robot_velocity_PID(20, 0, 0, 0, 50, 100, 0.2, 5.f/1000.f); //5 //18
...
void loop()
{
  ...
  if(current_time - prev_time > 5){
    ...
    float output_balance = 70.f * (pitch-BALANCE_ANGLE) + 67.f * imu.getPitchAngularVelocity(); //50 45; 70 67
    ...
    data[0] = -output_balance;
    data[1] = -output_velocity;
    data[2] = output_balance;
