...
String xbox_string()
{
  String str = String(xboxController.xboxNotif.btnY) + "," + // Y: 0/1
               ...
               String(xboxController.xboxNotif.btnSelect) + "," + // Window_button: 0/1
               String(xboxController.xboxNotif.btnStart) + "," + // Menue_button: 0/1
               String(xboxController.xboxNotif.btnXbox) + "," + // Xbox_button: 0/1
               String(xboxController.xboxNotif.btnShare) + "," + // uplaod_button: 0/1
