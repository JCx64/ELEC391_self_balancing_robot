...
PIDClass robot_velocity_PID(10, 12, 0, 0, 90, 100, 0.2, 5.f/1000.f); //5 //8
PIDClass robot_rotate_PID(0.1, 0, 0, 0, 50, 100, 0.2, 5.f/1000.f);
...
void loop()
{
  ...
  if(current_time - prev_time > 5){
    ...
    float output_balance = 26.f * (pitch-BALANCE_ANGLE) + 22.f * imu.getPitchAngularVelocity(); //24 20.5
    ...
    data[1] = output_velocity;
    data[2] = motor_right_velocity;
    data[3] = -output_velocity;
