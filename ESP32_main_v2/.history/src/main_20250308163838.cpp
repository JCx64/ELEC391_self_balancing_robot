...
int cur_Encoder_Right, pre_Encoder_Right = 0;
...
void loop()
{
  ...
  if(currentMillis - previousMillis >= 5){
    ...
    cur_Encoder_Right = robot_encoder.readMagEncoderRight();
    ...
    rpm_R = get_Right_drpm(robot_encoder.cur_Encoder_Right, robot_encoder.pre_Encoder_Right);
    printf("%lf, %lf\n", rpm_L, rpm_R);
    // printf("%lf\n", rpm_R);
    // printf("%lf\n", rpm_L);
    // printf("%d\n", cur_Encoder_Left);
