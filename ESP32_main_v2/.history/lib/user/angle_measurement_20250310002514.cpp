...
SimpleKalmanFilter kalmanX(1.f, 3.5f, 0.01f);
SimpleKalmanFilter kalmanY(1.f, 3.5f, 0.01f);
...
void AngleClass::update(){
    ...
    roll = kalmanX.updateEstimate(accAngleX + 0.3f * gyroX * 0.01f); // Roll
    pitch = kalmanY.updateEstimate(0.35 * accelAngleY + 0.65 * gyroY * 0.01f);  // Pitch
