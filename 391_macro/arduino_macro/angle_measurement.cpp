...
AngleClass :: AngleClass(float deltaT){
    TIMER_INTERVAL_MS = deltaT;
}

/**
 * @brief get angle calculated by accelerometer
 */
float AngleClass ::get_acc_angle(){
    float x, y, z;
 ...
 */
float AngleClass::get_gyro_angle(){
    float x, y, z;
 ...
 */
float AngleClass::get_comp_filter_angle(){
    float acc_x, acc_y, acc_z, gyro_x, gyro_y, gyro_z;
    float tilt_angle_acc, tilt_angle_gyro;
    float k = 0.45;
    ...
    return angle.comp_filter_angle;
}