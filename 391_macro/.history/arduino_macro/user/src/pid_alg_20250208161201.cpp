 ...
 */
void set_integral_max(float _integral_max){
...
void pid_TimerElapsedCallback(){
    ...
    error = angle_target - angle.comp_filter_angle;
    sum_error += error;

    //calculate output for kp
    kp_out = error * pid.k_p;
    ...
    kd_out = (prev_error - error) * pid.k_d;
