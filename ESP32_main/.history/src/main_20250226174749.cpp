...
String xbox_string()
{
  String str = String(xboxController.xboxNotif.btnY) + "," + // Y: 0/1
               ...
               String(xboxController.xboxNotif.joyLHori) + "," + // Left_JS_Horizontal: 0-32990-65530 (sensitive, need consider deadzone)
               String(xboxController.xboxNotif.joyLVert) + "," + // Left_JS_Vertical: 
