...
String xbox_string()
{
  String str = String(xboxController.xboxNotif.btnY) + "," + // Y: 0/1
               String(xboxController.xboxNotif.btnX) + "," + // X: 0/1
               String(xboxController.xboxNotif.btnB) + "," + // B: 0/1
               String(xboxController.xboxNotif.btnA) + "," + // A: 0/1
               String(xboxController.xboxNotif.btnLB) + "," + // Left_Button: 0/1
               String(xboxController.xboxNotif.btnRB) + "," + // Right_Button: 0/1
               String(xboxController.xboxNotif.btnSelect) + "," + // Window_button: 0/1 (中左)
               String(xboxController.xboxNotif.btnStart) + "," + // Menue_button: 0/1 (中右)
               String(xboxController.xboxNotif.btnXbox) + "," + // Xbox_button: 0/1 (中上)
               String(xboxController.xboxNotif.btnShare) + "," + // Uplaod_button: 0/1 (中下)
               String(xboxController.xboxNotif.btnLS) + "," + // Left_joystick_push: 0/1
               String(xboxController.xboxNotif.btnRS) + "," + // Right_joystie_push: 0/1
               String(xboxController.xboxNotif.btnDirUp) + "," + // Up_direction: 0/1 方向键上
               String(xboxController.xboxNotif.btnDirRight) + "," + // Right_direction: 0/1 方向键右
               String(xboxController.xboxNotif.btnDirDown) + "," + // Down_direction: 0/1 方向键下
               String(xboxController.xboxNotif.btnDirLeft) + "," + // Left_direction: 0/1 方向键左
               String(xboxController.xboxNotif.joyLHori) + "," + // Left_JS_Horizontal: 0-32990-65535 (too sensitive, need consider deadzone)
               String(xboxController.xboxNotif.joyLVert) + "," + // Left_JS_Vertical: 0-32630-65535 (too sensitive, need consider deadzone)
               String(xboxController.xboxNotif.joyRHori) + "," + // Right_JS_Horizontal: 0-32990-65535 (too sensitive, need consider deadzone)
               String(xboxController.xboxNotif.joyRVert) + "," + // Right_JS_Vertical: 0-32630-65535 (too sensitive, need consider deadzone)
               String(xboxController.xboxNotif.trigLT) + "," + // Left_trigger: 0-1023
               String(xboxController.xboxNotif.trigRT) + "\n"; // Right_trigger: 0-1023
  return str;
};
