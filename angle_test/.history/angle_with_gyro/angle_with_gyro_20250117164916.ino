...
@team: ELEC391 B2
@author: Jiayi Chen
@description: This is a test for Arduino Nano 33 BLE, using gyroscope to measure yaw angle of the board.
@date: 2025/1/17
...
float x, y, z, sample_time, yaw_angle, theta_zero=0;
...
void loop() {
  if (IMU.gyroscopeAvailable()) {
    ...
    yaw_angle = theta_zero + z*sample_time;

    //send yaw angle (to be plotted)
