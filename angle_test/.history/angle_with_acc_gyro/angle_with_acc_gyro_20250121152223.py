...
tilt_angle_text = ax.text(11, 9, "", fontsize=10, va="top", ha="left", transform=ax.transAxes)
fig.subplots_adjust(right=0.8)
tilt_angle_text_content = "Data Points:\n" + "\n".join([f"({x:.2f}, {y:.2f})" for x, y in zip(x_data[-5:], y_data[-5:])])
tilt_angle_text.set_text(text_content)
