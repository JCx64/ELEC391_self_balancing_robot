#@team: ELEC391 B2
#@author: Jiayi Chen
#@description: To plot the calculated tilt angle using data measured by accelerometer.
#@date: 2025/1/21
#@note: Arduino code use angle_with_acc.ino
...
ax.grid()
ax.legend()
ax.set_title('Measure tilt angle using Accelerometer')
